...
public class HamonStandBubbleCutterModel extends EntityModel<HamonStandBubbleCutterEntity> {

    private final ModelRenderer cutter;

    public HamonStandBubbleCutterModel() {
        texWidth = 32;
        texHeight = 32;
    ...
    @Override
    public void setupAnim(HamonStandBubbleCutterEntity entity, float walkAnimPos, float walkAnimSpeed, float ticks, float yRotationOffset, float xRotation) {
