...
public class AddonStands {
    ...
    public static final EntityStandSupplier<HamonStandType<StandStats>, StandEntityType<HouseOfEarthEntity>>
            HOUSE_OF_EARTH = new EntityStandSupplier<>(InitStands.HOUSE_EARTH);
